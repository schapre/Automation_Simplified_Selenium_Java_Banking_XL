@echo off
echo ==========================================
echo   Parallel Test Execution Suite
echo   Multi-Threading with 4 Threads
echo ==========================================
...
echo Step 1: Running tests in parallel mode...
echo ⚡ Using TestNG parallel execution (4 threads)
