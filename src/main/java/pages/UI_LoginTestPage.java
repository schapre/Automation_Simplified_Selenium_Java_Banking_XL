...
public class UI_LoginTestPage {
    ...
    private By successMessage = By.xpath(
            "//div[contains(@class,'success') or contains(@class,'alert-success') or contains(text(),'Success') or contains(text(),'Welcome')]");
    ...
    private By emailRequiredError = By.xpath(
            "//div[contains(@class,'error') or contains(@class,'alert-danger') or contains(text(),'required') or contains(text(),'Email')]");
    private By passwordRequiredError = By.xpath(
            "//div[contains(@class,'error') or contains(@class,'alert-danger') or contains(text(),'required') or contains(text(),'Password')]");
    private By invalidCredentialsError = By.xpath(
            "//div[contains(@class,'error') or contains(@class,'alert-danger') or contains(text(),'Invalid') or contains(text(),'incorrect')]");
    ...
    public void navigateToLoginPage() {
        String url = URLManager.getTesterBudLoginUrl();
        URLManager.logNavigation("Login Test", url);
        driver.get(url);
    }
